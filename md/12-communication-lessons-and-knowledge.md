...
- 来源：`communications\2026-05-27\161500-qa-migration.md`、`communications\2026-05-27\170345-skill-rebuild-source-md.md`
- 类型：自动化规则
- 内容：自动化可以从原仓库 `qa` 简版入口触发，但生成或更新 skill 时必须读取 Amadeus `md` 作为完整知识源；除单业务功能文档外，源 md 原则上一条对应一个通用 skill；若存在中断尝试，以最终记录为准；通用 skill 不写项目名、固定路径、业务模块或私有接口。
